        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          <div style="flex: 1;">
            <div style="font-size: 0.82rem; font-weight: 600; color: ${COLORS.deepIndigo};">
              ${escapeHtml(window.getFieldValue(temple, "temple_name_short") || window.getFieldValue(temple, "temple_name"))}
            </div>
            <div style="font-size: 0.7rem; color: ${COLORS.deepIndigo}; opacity: 0.7; margin-top: 1px;">
              ${escapeHtml(window.getFieldValue(temple, "town"))} · ${escapeHtml(window.getFieldValue(temple, "region"))}
            </div>
          </div>
        </div>
      </div>
        ...
        <div style="padding: 10px 8px; border-bottom: 1px solid ${COLORS.ivoryDark}; 
          ...
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <div style="flex: 1;">
              ...
              <div style="font-size: 0.7rem; color: ${COLORS.deepIndigo}; opacity: 0.7; margin-top: 1px;">
                ${escapeHtml(window.getFieldValue(temple, "town"))} · Abhimana Kshetram
              </div>
            </div>
          </div>
        </div>
